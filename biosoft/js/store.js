...
(function (global) {
  ...
  function createConvenio(data) {
    ...
    var c = Object.assign({ id: uid("cnv"), activo: true, descuentoGeneral: 0, tipoAjuste: "descuento", referencia: "", tieneCopago: false, copagoTipo: "fijo", copagoValor: 0, creadoEn: nowISO() }, data);
    db.convenios.push(c);
    saveDB(db);

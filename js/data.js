...
const BIO_DATA = {
  ...
  clientes: {
    vesga: {
      ...
      documentosDrive: {
        carpetaClienteId: '16cD7M_skaywa2Aq6-N7fn8GcRht8vNSU',
        carpetaClienteUrl: 'https://drive.google.com/drive/folders/16cD7M_skaywa2Aq6-N7fn8GcRht8vNSU',
        serviciosHabilitados: ['medicina_general', 'estetica'],
        documentos: [
          {codigo:'MAN-TH-001', driveId:'local', driveUrl:''},
          {codigo:'PER-TH-001', driveId:'local', driveUrl:''},
          {codigo:'PRO-TH-001', driveId:'local', driveUrl:''},
          {codigo:'FOR-TH-001', driveId:'local', driveUrl:''},
          {codigo:'MAN-INF-001', driveId:'local', driveUrl:''},
          {codigo:'PRO-INF-001', driveId:'local', driveUrl:''},
          {codigo:'FOR-INF-001', driveId:'local', driveUrl:''},
          {codigo:'MAN-DOT-001', driveId:'local', driveUrl:''},
          {codigo:'PRO-DOT-001', driveId:'local', driveUrl:''},
          {codigo:'FOR-DOT-001', driveId:'local', driveUrl:''},
          {codigo:'MAN-MED-001', driveId:'local', driveUrl:''},
          {codigo:'PRO-MED-001', driveId:'local', driveUrl:''},
          {codigo:'FOR-MED-001', driveId:'local', driveUrl:''},
          {codigo:'MAN-PP-001', driveId:'local', driveUrl:''},
          {codigo:'PRO-PP-001', driveId:'local', driveUrl:''},
          {codigo:'PRO-PP-002', driveId:'local', driveUrl:''},
          {codigo:'PRO-PP-003', driveId:'local', driveUrl:''},
          {codigo:'PRO-PP-004', driveId:'local', driveUrl:''},
          {codigo:'PRO-PP-005', driveId:'local', driveUrl:''},
          {codigo:'PRO-PP-006', driveId:'local', driveUrl:''},
          {codigo:'PRO-PP-007', driveId:'local', driveUrl:''},
          {codigo:'FOR-PP-001', driveId:'local', driveUrl:''},
          {codigo:'FOR-PP-002', driveId:'local', driveUrl:''},
          {codigo:'FOR-PP-003', driveId:'local', driveUrl:''},
          {codigo:'FOR-PP-004', driveId:'local', driveUrl:''},
          {codigo:'FOR-PP-005', driveId:'local', driveUrl:''},
          {codigo:'MAN-HC-001', driveId:'local', driveUrl:''},
          {codigo:'PRO-HC-001', driveId:'local', driveUrl:''},
          {codigo:'FOR-HC-001', driveId:'local', driveUrl:''},
          {codigo:'FOR-HC-002', driveId:'local', driveUrl:''},
          {codigo:'MAN-RCR-001', driveId:'local', driveUrl:''},
          {codigo:'FOR-RCR-001', driveId:'local', driveUrl:''},
          {codigo:'MAN-GC-001', driveId:'local', driveUrl:''},
          {codigo:'POL-GC-001', driveId:'local', driveUrl:''},
          {codigo:'PRO-GC-001', driveId:'local', driveUrl:''},
          {codigo:'PRO-GC-002', driveId:'local', driveUrl:''},
          {codigo:'PRO-GC-003', driveId:'local', driveUrl:''},
          {codigo:'MAN-HAB-001', driveId:'local', driveUrl:''},
          {codigo:'CHK-HAB-001', driveId:'local', driveUrl:''},
          {codigo:'FOR-HAB-001', driveId:'local', driveUrl:''},
        ]
      },
    }
  },
